...
void getData(char listname[], char resultlistname[], char swapR[], char compResult[]){
    ...
    fprintf(results, "# size | bubble | Insertion | Selection | Merge\n");
    fprintf(swapResult, "# size | bubble | Insertion | Selection | Merge\n");
    fprintf(comparationResult, "# size | bubble | Insertion | Selection | Merge\n");
...
void justForQuick(char listname[], char resultlistname[], char swapR[], char compResult[]){
    FILE *lData, *fData; // List of data, file with data
    lData = fopen(listname, "r");
    FILE *results = fopen(resultlistname, "w");
    FILE *swapResult = fopen(swapR, "w");
    ...
    fprintf(results, "# size | Quick\n");
    fprintf(swapResult, "# size | Quick\n");
    fprintf(comparationResult, "# size | Quick\n");
...
int main(){
    ...
    justForQuick("data/ListOrdered.txt", "data/results/Qordered_byTime.dat", "data/results/Qordered_bySwapNumber.dat", "data/results/ordered_QbyNumberComparations.dat");
    ...
    justForQuick("data/ListReverse.txt", "data/results/Qreverse_byTime.dat","data/results/Qreverse_bySwapNumber.dat", "data/results/Qreverse_byNumberComparations.dat");
    ...
    getData("data/ListUnordered.txt", "data/results/Qunordered_byTime.dat", "data/results/Qunordered_bySwapNumber.dat", "/data/results/Qunordered_byNumberComparation.dat");
    
    /*unsigned long int a=0 , b=0; 
    int *vector = readFile(vector, 1000000, "data/1000000_reverse.txt");
    vector = mergeSort(vector, 1000000, &a, &b);
